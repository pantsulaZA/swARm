...
IL2CPP_EXTERN_C const uint32_t NativeInputSystem_ShouldRunUpdate_m2DF525D2E20BB22089DDAEA127C6EB05F5EEDEF1_MetadataUsageId;
...
// System.Boolean UnityEngineInternal.Input.NativeInputSystem::ShouldRunUpdate(UnityEngineInternal.Input.NativeInputUpdateType)
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool NativeInputSystem_ShouldRunUpdate_m2DF525D2E20BB22089DDAEA127C6EB05F5EEDEF1 (int32_t ___updateType0, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (NativeInputSystem_ShouldRunUpdate_m2DF525D2E20BB22089DDAEA127C6EB05F5EEDEF1_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	...
	bool V_1 = false;
	{
		...
		V_0 = L_0;
		Func_2_t9A2EAEA48EB870B763F1AB3E671CE2745D638867 * L_1 = V_0;
		if (!L_1)
		{
			goto IL_001a;
		}
	}
	{
		...
		int32_t L_3 = ___updateType0;
		NullCheck(L_2);
		bool L_4 = Func_2_Invoke_m3EBFD1B2C975E45C26C2322E78FB7E4297168511(L_2, L_3, /*hidden argument*/Func_2_Invoke_m3EBFD1B2C975E45C26C2322E78FB7E4297168511_RuntimeMethod_var);
		V_1 = L_4;
		goto IL_0026;
	}
...
IL_001a:
	{
		...
		IL2CPP_RUNTIME_CLASS_INIT(NativeInputSystem_t522F6391494159917EE6963E9E61C9EFA9C5795C_il2cpp_TypeInfo_var);
		bool L_6 = NativeInputSystem_ShouldUpdateFallback_m2A77098594A6943311493B3889957AA1DD9288DF(L_5, /*hidden argument*/NULL);
		V_1 = L_6;
		goto IL_0026;
	}
